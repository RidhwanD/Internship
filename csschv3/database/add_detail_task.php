<?php
	...
	try{
		...
		//$result2 = $conn->prepare("select (select area from ruangan where koderuangan = '$kodeR') as area, starttime, endtime from task natural join detailtask where shift = '$shift'");
		//$result2->execute();
